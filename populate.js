...
function CreateSite(siteId, siteName, addressObjid){
  var SiteObjid = 0;
  //var SiteId = '';
...
CreateQueue("Hardware")
CreateQueue("Software")
CreateQueue("Support")
CreateQueue("Sales")
...
var address1 = "8900 Business Park Drive";
var address2 = "";
var city="Austin";
var state = "TX";
var zip = "78759";
...
var address1 = "4807 Spicewood Springs Road";
var address2 = "";
var city="Austin";
var state = "TX";
var zip = "78759";
...
var siteId = CreateSite("First Choice Software", addressObjid1);
var siteId2 = CreateSite("Dovetail Software", addressObjid2);
var siteId3 = CreateSite("Itty Bitty Machine Corporation", addressObjid3);
var siteId4 = CreateSite("Round Rock Computers", addressObjid4);
...
var contactRole="";
var contactObjid1 = CreateContact("Mark","Miller","877-510-5466",siteId,"mmiller@example.com",contactRole);
var contactObjid2 = CreateContact("James","Miller","877-510-7654",siteId2,"jmiller@example.com",contactRole)
var contactObjid3 = CreateContact("Janet","Berry","617-510-7654",siteId3,"jberry@example.com",contactRole)
